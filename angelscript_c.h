...
extern "C"
{
	...
	// String factory
	AS_API int                asEngine_RegisterStringFactory(asIScriptEngine *e, const char *datatype, asGETSTRINGCONSTFUNC_t getStr, asRELEASESTRINGCONSTFUNC_t releaseStr, getRawStr asGETRAWSTRINGDATAFUNC_t);
